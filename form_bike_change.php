...
<head>
    ...
    <?php
   $q312 = "SELECT * FROM `bike` WHERE id = ".$_GET['id'];
   ...
   while ($row = $csc->fetch())
   {
       ...
       $brand = $row['brand'];
       $name = $row['name'];
       $frameset = $row['frameset'];
       $wheelset = $row['wheelset'];
       $transmission = $row['transmission'];
       $img = $row['img'];
   }
    ?>
    <title>Change bike</title>    
</head>
<body>
    <header>
    <a href='main.php'>
    ...
    <form name="form" method="post" action="change_bike.php" enctype="multipart/form-data">
        <table>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
                <select name="frameset">
                    ...
                    {
                        if ($frameset == $row['id']){
                            echo "<option selected value='" . $row['id'] . "'>" . $row['frame'] . " (" . $row['mf'] . " " . $row['front'] . ", " . $row['mb'] . " " . $row['back'] . ")" . "</option>";
                        } else {
        ...
        <tr>
            ...
            <td>
                <select name="wheelset">
                    ...
                    {
                        if ($wheelset == $row['id']){
                            echo "<option selected value='" . $row['id'] . "'>" . $row['diameter'] . " (" . $row['mr'] . " " . $row['rim'] . ", " . $row['mt'] . " " . $row['tire'] . ")" . "</option>";
                        } else {
